...
exp="debug"
seed_max=1
model_dir="/workspace/on-policy/offpolicy/scripts/results/MPE/simple_catching_expert_both/rmappo/EnvV4_ExpPrey_NoPreyVolo_AddMAAC_test/wandb/run-20230227_195500-1tf94g8t/files"
load_model_ep=1800
num_test_episode=10
