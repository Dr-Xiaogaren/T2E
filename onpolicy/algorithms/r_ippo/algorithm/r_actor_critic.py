...
class R_CNNCritic(nn.Module):
    """
    Critic network class for IPPO.
    :param args: (argparse.Namespace) arguments containing relevant model information.
    :param CNNbase: (nn.Module) CNNBase class for feature extraction.
    :param FCbase: (nn.Module) FCBase class for feature extraction.
    ...
    def forward(self, obs, rnn_states, masks):
        ...
        # encode respectively      
        critic_features_from_cnn = self.CNNbase(obs_for_cnn)
        critic_features_from_fc = self.FCbase(obs_for_fc)
...
class R_CNNActor(nn.Module):
    """
    Actor network class for IPPO. Outputs actions given observations.
    :param args: (argparse.Namespace) arguments containing relevant model information.
    :param CNNbase: (nn.Module) CNNBase class for feature extraction.
    :param FCbase: (nn.Module) FCBase class for feature extraction.
    :param obs_space: (gym.Space) observation space.
